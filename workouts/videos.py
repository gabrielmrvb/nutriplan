...
MOVIMENTO_ESPERADO = {
    ...
    "Tríceps testa com barra": ["triceps testa", "testa", "skull crusher",
                                "frances"],
    # Os 28 de 16/09/2026, inativos até a mídia ser conferida. A tabela
    # cobre o catálogo INTEIRO (há teste), então o guarda já sabe o que
    # cobrar no dia em que cada `video` for preenchido.
    "Supino reto com halteres": ["supino reto", "supino com halter", "dumbbell bench",
                                 "dumbbell press"],
    "Supino na máquina": ["supino maquina", "supino na maquina", "machine press",
                          "chest press", "supino reto maquina", "supino sentado"],
    "Crucifixo com halteres": ["crucifixo", "dumbbell fly", "flyes"],
    "Crossover na polia": ["crossover", "cross over", "crucifixo na polia",
                           "crucifixo no cross", "cable fly"],
    "Puxada frente com pegada supinada": ["puxada", "supinada", "pulldown",
                                          "pull down", "puxador"],
    "Barra fixa com pegada supinada": ["barra fixa", "supinada", "chin up", "chin-up",
                                       "chinup"],
    "Remada curvada com halteres": ["remada curvada", "remada com halter",
                                    "dumbbell row"],
    "Remada articulada na máquina": ["remada articulada", "remada maquina",
                                     "remada na maquina", "machine row",
                                     "iso row"],
    "Desenvolvimento na máquina": ["desenvolvimento", "shoulder press",
                                   "machine press"],
    "Desenvolvimento com barra": ["desenvolvimento", "press militar",
                                  "military press", "overhead press", "ohp"],
    "Face pull na polia": ["face pull", "facepull", "pull face", "pullface"],
    ...
    "Panturrilha no leg press": ["panturrilha", "calf", "leg press"],
    "Panturrilha em pé com halteres": ["panturrilha", "calf"],
    "Rosca Scott com barra": ["scott", "preacher"],
    "Rosca concentrada": ["concentrada", "concentration"],
    "Rosca na polia baixa": ["rosca", "polia", "pulley", "cable curl"],
    "Supino fechado com barra": ["supino fechado", "pegada fechada",
                                 "close grip", "close-grip"],
    "Mergulho nas paralelas": ["mergulho", "paralela", "dips", "dip"],
    "Tríceps francês com halter": ["frances", "triceps", "overhead",
                                   "extensao"],
    "Encolhimento com barra": ["encolhimento", "shrug"],
