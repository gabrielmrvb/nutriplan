...
- `/treino/agora/` · vídeo aberto · o botão "fechar" do app fica em cima do título que o YouTube desenha no topo do iframe ("LEG PRESS 45° (EXECUÇ… fechar") · o fechar fora da área do título do player (canto inferior, ou o próprio botão "ver vídeo" vira "fechar") · `achados/prototipos-20260920/proto1-antes-ferro-390.png` (branch `proto/execucao-sem-recarga`) · feio · UX REAL `[OBSERVADA local]`
